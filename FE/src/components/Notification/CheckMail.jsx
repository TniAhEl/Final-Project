  ...
  <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/10">
    <div className="w-full max-w-sm px-8 py-8 bg-white rounded-2xl shadow-2xl relative flex flex-col items-center">
      ...
      <div className="w-full flex flex-col items-center gap-2">
        <div className="text-center text-gray-900 text-2xl font-bold font-['Inter'] leading-tight">
          Check Your Email
        </div>
        <div className="text-center text-gray-500 text-base font-medium font-['Inter'] leading-snug">
          We have just sent to{" "}
          <span className="text-indigo-600 font-semibold">Info@Flexui.io</span>{" "}
