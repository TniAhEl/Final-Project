...
const WarrantyCard = ({
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-xl shadow p-5 flex flex-col gap-3 max-w-md">
      ...
      <button onClick={onViewDetail} className="px-4 py-2 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition text-sm font-medium self-end">View Details</button>
    </div>
  );
};
