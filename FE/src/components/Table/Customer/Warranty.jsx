    ...
    <div className="w-full rounded-lg overflow-hidden border border-slate-300 bg-white font-['Roboto']">
      <div className="divide-y divide-slate-300">
        ...
        <div className="flex bg-neutral-50">
          <div className="w-40 p-4 text-slate-800/90 text-sm font-medium">Mã bảo hành</div>
        ...
        {/* Rows */}
        {warranties.length === 0 && (
          <div className="p-6 text-center text-gray-400 w-full">Không có bảo hành nào.</div>
        )}
