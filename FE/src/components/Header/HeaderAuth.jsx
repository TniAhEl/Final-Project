...
// Function to decode JWT to get userId and role from token
...
const HeaderAuth = () => {
  ...
  return (
    <>
            ...
            {openUser && (
              <div className="absolute right-0 mt-2 w-40 bg-white rounded shadow-lg z-10">
                <button
                  ...
                  className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-100 cursor-pointer transition-colors duration-200"
                >
                  Profile
                </button>
                <button
                  ...
                  className="block w-full text-left px-4 py-2 text-red-600 hover:bg-gray-100 cursor-pointer transition-colors duration-200"
                >
                  Logout
                </button>
              </div>
      ...
      >
        <SidebarCart onGoToCart={handleGoToCart} ref={cartRef} />
      </div>
    </>
  );
};
