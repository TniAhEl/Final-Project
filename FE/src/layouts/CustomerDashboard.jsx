          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ borderBottom: "1px solid #f0f0f0" }}>
                <th style={{ padding: "12px 8px", textAlign: "left", color: "#666" }}>Mã đơn hàng</th>
                <th style={{ padding: "12px 8px", textAlign: "left", color: "#666" }}>Sản phẩm</th>
                <th style={{ padding: "12px 8px", textAlign: "left", color: "#666" }}>Tổng tiền</th>
                <th style={{ padding: "12px 8px", textAlign: "left", color: "#666" }}>Trạng thái</th>
                <th style={{ padding: "12px 8px", textAlign: "left", color: "#666" }}>Ngày đặt</th>
              </tr>
            </thead>
            <tbody>
              <tr style={{ borderBottom: "1px solid #f0f0f0" }}>
